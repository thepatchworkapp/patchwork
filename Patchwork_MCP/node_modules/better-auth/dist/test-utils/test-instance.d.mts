...
declare function getTestInstance<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O | undefined, config?: {
  ...
  client: UnionToIntersection<(C extends undefined ? {} : C) & {
    ...
    readonly ok: better_call287.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call287.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call287.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
    ...
    readonly sendVerificationEmail: better_call287.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod613.ZodObject<{
        email: zod613.ZodEmail;
    ...
    readonly changePassword: better_call287.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod613.ZodObject<{
        newPassword: zod613.ZodString;
    ...
    readonly deleteUser: better_call287.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call287.MiddlewareInputContext<better_call287.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeSessions: better_call287.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call287.MiddlewareInputContext<better_call287.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly listUserAccounts: better_call287.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call287.MiddlewareInputContext<better_call287.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call287.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod613.ZodObject<{
        token: zod613.ZodString;
        callbackURL: zod613.ZodOptional<zod613.ZodString>;
    ...
    readonly unlinkAccount: better_call287.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod613.ZodObject<{
        providerId: zod613.ZodString;
        accountId: zod613.ZodOptional<zod613.ZodString>;
      }, zod_v4_core91.$strip>;
      use: ((inputContext: better_call287.MiddlewareInputContext<better_call287.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly refreshToken: better_call287.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod613.ZodObject<{
        providerId: zod613.ZodString;
        accountId: zod613.ZodOptional<zod613.ZodString>;
        userId: zod613.ZodOptional<zod613.ZodString>;
      }, zod_v4_core91.$strip>;
      metadata: {
        openapi: {
          description: string;
    ...
    readonly getAccessToken: better_call287.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod613.ZodObject<{
        providerId: zod613.ZodString;
        accountId: zod613.ZodOptional<zod613.ZodString>;
    ...
    readonly accountInfo: better_call287.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call287.MiddlewareInputContext<better_call287.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
  ...
  })["plugins"] extends (infer Plugin_1)[] ? UnionToIntersection<Plugin_1 extends _better_auth_core23.BetterAuthClientPlugin ? Plugin_1["getActions"] extends ((...args: any) => infer Actions) ? Actions : {} : {}> : {}) & UnionToIntersection<InferRoute<((C extends undefined ? {} : C) & {
    baseURL: string | undefined;
    fetchOptions: {
      customFetchImpl: (url: string | URL | Request, init?: RequestInit | undefined) => Promise<Response>;
    };
