...
import * as better_call874 from "better-call";

//#region src/api/routes/account.d.ts
declare const listUserAccounts: better_call874.StrictEndpoint<"/list-accounts", {
  method: "GET";
...
declare const getAccessToken: better_call874.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
