...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Awaitable<AuthContext>, options: Option): {
  api: {
    readonly ok: better_call3.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call3.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call3.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
      body: zod0.ZodObject<{
    ...
    readonly callbackOAuth: better_call3.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
    ...
    readonly getSession: better_call3.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: zod0.ZodOptional<zod0.ZodObject<{
    ...
    readonly signOut: better_call3.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call3.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
    ...
    readonly signInEmail: better_call3.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      body: zod0.ZodObject<{
    ...
    readonly resetPassword: better_call3.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: zod0.ZodOptional<zod0.ZodObject<{
    ...
    readonly verifyEmail: better_call3.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
      ...
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          description: string;
          parameters: ({
    ...
    readonly sendVerificationEmail: better_call3.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod0.ZodObject<{
        email: zod0.ZodEmail;
    ...
    readonly changeEmail: better_call3.StrictEndpoint<"/change-email", {
      method: "POST";
      body: zod0.ZodObject<{
        newEmail: zod0.ZodEmail;
        callbackURL: zod0.ZodOptional<zod0.ZodString>;
      }, zod_v4_core0.$strip>;
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly changePassword: better_call3.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod0.ZodObject<{
        newPassword: zod0.ZodString;
    ...
    readonly setPassword: better_call3.StrictEndpoint<string, {
      method: "POST";
      body: zod0.ZodObject<{
        newPassword: zod0.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    readonly updateUser: better_call3.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
    ...
    readonly deleteUser: better_call3.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call3.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: zod0.ZodObject<{
        email: zod0.ZodEmail;
    ...
    readonly requestPasswordResetCallback: better_call3.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: zod0.ZodObject<{
    ...
    readonly listSessions: better_call3.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call3.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: zod0.ZodObject<{
        token: zod0.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    readonly revokeSessions: better_call3.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call3.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call3.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod0.ZodObject<{
        callbackURL: zod0.ZodOptional<zod0.ZodString>;
    ...
    readonly listUserAccounts: better_call3.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call3.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod0.ZodObject<{
        token: zod0.ZodString;
        callbackURL: zod0.ZodOptional<zod0.ZodString>;
    ...
    readonly unlinkAccount: better_call3.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod0.ZodObject<{
    ...
    readonly refreshToken: better_call3.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod0.ZodObject<{
        providerId: zod0.ZodString;
        accountId: zod0.ZodOptional<zod0.ZodString>;
    ...
    readonly getAccessToken: better_call3.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod0.ZodObject<{
        providerId: zod0.ZodString;
        accountId: zod0.ZodOptional<zod0.ZodString>;
    ...
    readonly accountInfo: better_call3.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call3.MiddlewareInputContext<better_call3.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
