...
declare const addMember: <O extends OrganizationOptions>(option: O) => better_call763.StrictEndpoint<string, {
  method: "POST";
  body: z.ZodObject<{
...
declare const removeMember: <O extends OrganizationOptions>(options: O) => better_call763.StrictEndpoint<"/organization/remove-member", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call763.MiddlewareInputContext<{
    use: ((inputContext: better_call763.MiddlewareInputContext<better_call763.MiddlewareOptions>) => Promise<{
      session: {
...
declare const updateMemberRole: <O extends OrganizationOptions>(option: O) => better_call763.StrictEndpoint<"/organization/update-member-role", {
  method: "POST";
  body: z.ZodObject<{
    role: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
...
declare const getActiveMember: <O extends OrganizationOptions>(options: O) => better_call763.StrictEndpoint<"/organization/get-active-member", {
  method: "GET";
  use: (((inputContext: better_call763.MiddlewareInputContext<better_call763.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const leaveOrganization: <O extends OrganizationOptions>(options: O) => better_call763.StrictEndpoint<"/organization/leave", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call763.MiddlewareInputContext<better_call763.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
...
declare const listMembers: <O extends OrganizationOptions>(options: O) => better_call763.StrictEndpoint<"/organization/list-members", {
  method: "GET";
...
declare const getActiveMemberRole: <O extends OrganizationOptions>(options: O) => better_call763.StrictEndpoint<"/organization/get-active-member-role", {
  method: "GET";
  query: z.ZodOptional<z.ZodObject<{
