...
import * as zod1927 from "zod";
import * as better_call655 from "better-call";
import * as zod_v4_core271 from "zod/v4/core";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      matcher: (ctx: _better_auth_core29.HookEndpointContext) => boolean;
      handler: (inputContext: better_call655.MiddlewareInputContext<better_call655.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call655.MiddlewareContext<better_call655.MiddlewareOptions, _better_auth_core29.AuthContext & {
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call655.StrictEndpoint<"/api-key/create", {
      method: "POST";
      body: zod1927.ZodObject<{
        name: zod1927.ZodOptional<zod1927.ZodString>;
        expiresIn: zod1927.ZodDefault<zod1927.ZodNullable<zod1927.ZodOptional<zod1927.ZodNumber>>>;
        userId: zod1927.ZodOptional<zod1927.ZodCoercedString<unknown>>;
        prefix: zod1927.ZodOptional<zod1927.ZodString>;
        remaining: zod1927.ZodDefault<zod1927.ZodNullable<zod1927.ZodOptional<zod1927.ZodNumber>>>;
     ...
     */
    deleteAllExpiredApiKeys: better_call655.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
