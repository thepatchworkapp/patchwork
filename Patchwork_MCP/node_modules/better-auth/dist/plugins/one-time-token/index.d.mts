...
import * as better_call223 from "better-call";
...
declare const oneTimeToken: (options?: OneTimeTokenOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateOneTimeToken: better_call223.StrictEndpoint<"/one-time-token/generate", {
      method: "GET";
      use: ((inputContext: better_call223.MiddlewareInputContext<better_call223.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyOneTimeToken: better_call223.StrictEndpoint<"/one-time-token/verify", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      matcher: () => true;
      handler: (inputContext: better_call223.MiddlewareInputContext<better_call223.MiddlewareOptions>) => Promise<void>;
    }[];
  };
