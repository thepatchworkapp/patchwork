...
import * as better_call653 from "better-call";
...
declare const lastLoginMethod: <O extends LastLoginMethodOptions>(userConfig?: O | undefined) => {
  ...
  init(ctx: _better_auth_core28.AuthContext): {
    options: {
      databaseHooks: {
        user: {
          create: {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call653.MiddlewareInputContext<better_call653.MiddlewareOptions>) => Promise<void>;
    }[];
  };
