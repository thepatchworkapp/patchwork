...
export class Go {
    ...
    constructor() {
        ...
        const loadSlice = (array, len, _cap) => {
            return new Uint8Array(this._inst.exports.memory.buffer, array, len);
        };
        const loadSliceOfValues = (array, len, _cap) => {
        ...
        this.importObject = {
            ...
            gojs: {
                ...
                "syscall/js.copyBytesToJS": (ret_addr, dst_ref, src_addr, src_len, _src_cap) => {
                    const num_bytes_copied_addr = ret_addr;
                    const returned_status_addr = ret_addr + 4; // Address of returned boolean status variable
...
//# sourceMappingURL=goRuntime.js.map